-- Business Profile and Registration Schema
-- This file contains the database schema for Epic 4: Business Features
...
CREATE TABLE IF NOT EXISTS business_reviews (
    ...
    -- Review Content (Binary System as per project brief)
