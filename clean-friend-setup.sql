-- CLEAN SLATE Friend Management Database Setup
-- This drops existing friend tables and recreates them from scratch
-- Run this in your Supabase SQL Editor

-- STEP 1: Drop existing friend-related tables (if they exist)
-- This removes any conflicting schema
...
-- STEP 6: Set up test users in profiles table
-- Insert or update profiles for your 3 test users
...
SELECT '🎉 Clean Friend Management Database Setup Complete!' as status;
...
SELECT '✅ Ready to test friend search! Sign in as testuser1@gmail.com' as final_status;