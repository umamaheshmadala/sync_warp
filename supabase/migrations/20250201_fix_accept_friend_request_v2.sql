-- Fix accept_friend_request to remove reference to non-existent updated_at column
-- Story 9.3.2 / Bugfix V2
...
BEGIN
  ...
  DO UPDATE SET 
    status = 'active',
    -- updated_at column does not exist on friendships table
