-- Drop and recreate get_conversation_messages to include parent message data
...
RETURNS TABLE (
  ...
  link_preview JSONB,
  thumbnail_url TEXT,
  parent_message JSONB  -- NEW: Parent message for replies
) AS $$
DECLARE
  v_user_id UUID;
...
COMMENT ON FUNCTION get_conversation_messages IS 'STORY 8.10.5: Fetch messages with parent message data for replies';
