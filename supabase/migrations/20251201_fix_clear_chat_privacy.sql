-- Add cleared_history_at column to conversation_participants
ALTER TABLE conversation_participants
ADD COLUMN IF NOT EXISTS cleared_history_at TIMESTAMPTZ;

-- Update clear_chat_history to use timestamp instead of deleting messages
...
BEGIN
  ...
  -- Update cleared_history_at timestamp
...
-- New RPC to fetch messages with filtering
...
BEGIN
  ...
  SELECT cleared_history_at INTO v_cleared_at
