-- Migration: Fix Chat Visibility After Deletion
-- Story: Bugfix
-- Description: Updates get_conversation_messages to respect deleted_at timestamp from conversation_participants
-- Date: 2025-12-27
...
COMMENT ON FUNCTION get_conversation_messages IS 'Fetch messages with visibility filtered by deleted_at and cleared_history_at';
