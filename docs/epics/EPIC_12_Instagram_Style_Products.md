...
### Instagram-Style 3-Step Creation Wizard

**Entry Point**: "+ Add Product" button opens modal/full-screen wizard

```
STEP 1: Select Media           STEP 2: Edit & Arrange         STEP 3: Details
┌─────────────────────┐        ┌─────────────────────┐        ┌─────────────────────┐
│                     │        │  ← Back      Next → │        │  ← Back     [Share] │
│  Create new product │        ├─────────────────────┤        ├─────────────────────┤
│                     │        │                     │        │  Preview images     │
│  ┌───────────────┐  │        │   MAIN PREVIEW      │        │  ───────────────    │
│  │ 🖼️ 🎬         │  │        │   (with carousel)   │        │  Product Name *     │
│  │               │  │        │                     │        │  Description        │
│  │ Drag here or  │  │  →→    │  Thumbnail strip    │  →→    │  Tags: [pills]      │
│  │ Select files  │  │        │  [✂️Crop][🔄Rotate] │        │  🔔 Notifications   │
│  │               │  │        │                     │        │  ───────────────    │
│  └───────────────┘  │        │                     │        │  [Save as Draft]    │
│                     │        └─────────────────────┘        └─────────────────────┘
└─────────────────────┘

Drafts Tab (in Products section):
┌──────────────────────────────────────────────┐
│  [📦 Products]  [📝 Drafts (3)]  [+ Add]     │
├──────────────────────────────────────────────┤
│  Draft cards with: thumbnail, name,          │
│  image count, last updated timestamp         │
