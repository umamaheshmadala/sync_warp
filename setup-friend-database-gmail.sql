-- Friend Management Database Setup with CORRECT gmail.com addresses
...
-- STEP 6: Set up test users with CORRECT gmail.com addresses
-- This will run AFTER you create the 3 new users through signup
...
SELECT 
    CASE 
        WHEN COUNT(*) = 0 THEN '⚠️ No test users found! Please sign up the 3 test users first.'
