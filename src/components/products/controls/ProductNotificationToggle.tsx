...
export const ProductNotificationToggle: React.FC<ProductNotificationToggleProps> = ({
    ...
    return (
        <div className={`flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg ${className}`}>
            ...
            <button
                ...
                disabled={updating}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${enabled ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600'
                    }`}
            >
                {updating ? (
