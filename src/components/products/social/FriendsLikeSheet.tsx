        ...
        <DrawerPrimitive.Root open={isOpen} onOpenChange={onOpenChange} shouldScaleBackground>
            <DrawerPrimitive.Portal>
                ...
                <DrawerPrimitive.Content
                    className="fixed inset-x-0 bottom-0 z-[200] mt-24 flex max-h-[85vh] flex-col rounded-t-[10px] border bg-white shadow-2xl outline-none"
                    ...
                    <div className="flex-1 overflow-y-auto p-4 bg-gray-50/50">
                        {friends.length === 0 ? (
                            ...
                            <div className="space-y-3 pb-8">
                                {friends.map((friend) => (
                                    <div key={friend.user_id} className="flex items-center gap-3 bg-white p-3 rounded-xl border">
