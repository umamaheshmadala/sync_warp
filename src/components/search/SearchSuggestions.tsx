...
export const SearchSuggestions: React.FC<SearchSuggestionsProps> = ({
  ...
  if (isLoading) {
    return (
      <div
        ref={containerRef}
        className="absolute top-full left-0 z-50 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg py-2 min-w-[280px] w-max max-w-[90vw] sm:w-full"
      >
  ...
  return (
    <div
      ref={containerRef}
      className="absolute top-full left-0 z-50 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-80 overflow-y-auto min-w-[280px] w-max max-w-[90vw] sm:w-full"
    >
      {/* Search Suggestions */}
      {hasSuggestions && (
        <div className="py-2">
