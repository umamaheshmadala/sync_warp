...
const SimpleBusinessDashboard: React.FC = () => {
        ...
        {businesses.length > 0 ? (
          <>
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {/* Total Businesses */}
                <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-purple-200">
                ...
                {/* Average Rating */}
                <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-amber-200">
                  <div className="flex items-center">
                ...
                {/* Total Reviews */}
                <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-blue-200">
                  <div className="flex items-center">
                ...
                {/* Total Check-ins */}
                <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-green-200">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-semibold text-gray-900">{stats.totalCheckins}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {businesses.map((business, index) => (
                  <motion.div
                    ...
                    className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-white/50 hover:shadow-lg transition-all duration-300"
                  >
                    {/* Cover Image */}
                    <div className="h-48 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg overflow-hidden mb-6 relative">
                      ...
                      <div className="absolute top-4 right-4">
                        <div className={`flex items-center px-3 py-1.5 rounded-full text-sm font-medium backdrop-blur-md ${
                          business.status === 'active' ? 'bg-emerald-100/80 text-emerald-700' :
                      ...
                      {business.verified && (
                        <div className="absolute top-4 left-4">
                          <div className="flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-blue-100/80 text-blue-700 backdrop-blur-md">
          ...
          >
            <div className="max-w-2xl mx-auto">
              <div className="bg-white/60 backdrop-blur-md rounded-2xl p-12 border border-white/50">
                <motion.div
                  animate={{ 
                    rotate: [0, 10, -10, 0],
                    scale: [1, 1.05, 1]
